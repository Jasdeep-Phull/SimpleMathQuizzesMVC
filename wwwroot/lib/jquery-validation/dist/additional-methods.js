...
// Custom Validation:
// (Float regex adapted from this: https://stackoverflow.com/a/53000526)

/* additional-methods.min.js is not updated with this validation
$.validator.addMethod( "isinteger", function( value, element ) {
	return this.optional(element) || /^(-)?(0|([1-9](\d)*))$/.test(value.trim());
...
// build project and see if this is in the min.js file. If not, use this instead of the min.js file
return $;
}));